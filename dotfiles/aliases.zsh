...
alias gstnr="git stash store $(gst)"
alias gt="git tag"
...
alias pyms="pym shell"
alias pymmm="pym makemigrations"
alias pymm="pym migrate"
alias pymt="pym test"
alias pymsa="pym startapp"
alias pymcs="pym clearsessions"
alias pymgs="pym generateschema"
alias pymsu="pym show_urls"
alias wpy="psc py"
